            ...
            <div id="endingFilter">
                ...
                <p><a href="/auctions/filter/ending-thisweek">Ending this week</a>
                    @if (session('filter.ending.thisweek'))
                        <a href="/auctions/filter/delete/ending-thisweek">delete filter</a>
                    @endif</p>
                <p><a href="/auctions/filter/ending-purchasenow">Purchase now</a>
                    @if (session('filter.ending.purchasenow'))
                        <a href="/auctions/filter/delete/ending-purchasenow">delete filter</a>
                    @endif</p>
            </div>            
        </div>
        <div class="col-md-3">
            <div id="eraFilter">
                ...
                <p>
                    ...
                    @if (session('filter.pre-War'))
                        <a href="/auctions/filter/delete/prewar">delete filter</a>
                    @endif
                </p>
                <p><a href="/auctions/filter/yearbetween-1940-1960">1940s-1950s</a>
                    @if (session('filter.yearbetween.1940-1960'))
                        <a href="/auctions/filter/delete/yearbetween-1940-1960">delete filter</a>
                    @endif
                </p>
                ...
                <p><a href="/auctions/filter/yearabove">1990s-present</a>
                    @if (session('filter.yearabove'))
                        <a href="/auctions/filter/delete/yearabove">delete filter</a>
                    @endif
                </p>
            </div>
            ...
            <div id="styleFilter">
                ...
                <p>
                    ...
                    @if (session('filter.style.abstract'))
                        <a href="/auctions/filter/delete/style-Abstract">delete filter</a>                    
                    @endif
                </p>
                <p><a href="/auctions/filter/style-African_American">African American</a>
                    @if (session('filter.style.African_American'))
                        <a href="/auctions/filter/delete/style-African_American">delete filter</a>
                    @endif
                </p>
                <p><a href="/auctions/filter/style-Asian_Contemporary">AsianContemporary</a>
